...
<div class="breadcrumb-holder container-fluid">
  <ul class="breadcrumb" style="position: relative;">
    ...
    @hasrole('admin')
    <a href="{{route('physicians.create')}}" class="btn btn-info  text-right" style="position: absolute; right: 40px; bottom: 7px;">Add New</a>
    @endhasrole
  </ul>
</div>
<!-- Forms Section-->
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    data: @json($physicians),//ho phet ka par lar tae variable
    columns: [
    { 
