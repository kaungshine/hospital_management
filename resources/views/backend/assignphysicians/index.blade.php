...
<div class="breadcrumb-holder container-fluid">
  <ul class="breadcrumb" style="position: relative;">
    ...
    @hasrole('admin')
    <a href="{{route('assignphysicians.create')}}" class="btn btn-info  text-right" style="position: absolute; right: 40px; bottom: 7px;">Add New</a>
    @endhasrole
  </ul>
</div>
<!-- Forms Section-->
      ...
      <div class="modal-body">
        ...
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h3 class="h4">Department_Physician Edit Form</h3>
          </div>
          <div class="card-body">
            <form id="update-form" class="form-horizontal">
              ...
              <div class="form-group row">
                <label class="col-sm-4 form-control-label">Physician</label>
                <div class="col-sm-8">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    columns: [
    { 
          title: "Department",//Table Header/ Column Name
          class: "text-center",
          data: "department",
          searchable: true,
          orderable: true
    ...
    $('#location_table').on('click', '.btn_edit', function (e){
      ...
      .then(json => {
        ...
        $('#department').find("option[value='" + json.department_id + "']").attr('selected', true)
