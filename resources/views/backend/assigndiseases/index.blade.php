...
<div class="breadcrumb-holder container-fluid">
  <ul class="breadcrumb" style="position: relative;">
    ...
    <li class="breadcrumb-item active">Assign Disease</li>
    {{-- @hasrole('admin')
    <a href="{{route('assigndiseases.create')}}" class="btn btn-info  text-right" style="position: absolute; right: 40px; bottom: 7px;">Add New</a>
    @endhasrole --}}
  </ul>
</div>
<!-- Forms Section-->
      ...
      <div class="modal-body">
        ...
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h3 class="h4">Disease_Patient Edit Form</h3>
          </div>
          <div class="card-body">
            <form id="update-form" class="form-horizontal">
              ...
              <div class="form-group row">
                <label class="col-sm-4 form-control-label">Patient</label>
                <div class="col-sm-8">
              ...
              <div class="form-group row">
                <label class="col-sm-4 form-control-label">Disease</label>
                <div class="col-sm-8">
                  <select name="disease" id="disease" class="form-control mb-3">
  ...
  $(document).ready(function() {
    ...
    $('#location_table').on('click', '.btn_edit', function (e){
      ...
      .then(json => {
        ...
        $('#disease').find("option:selected").attr('selected', false)
        $('#patient').find("option[value='" + json.patient_id + "']").attr('selected', true)
        $('#disease').find("option[value='" + json.disease_id + "']").attr('selected', true)
