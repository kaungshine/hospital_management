  ...
  <div class="row bg-white has-shadow">
    ...
    <div class="col-xl-3 col-sm-6">
      <div class="item d-flex align-items-center">
        ...
        <div class="title"><span>Doctors</span>
          <div class="progress">
            <div role="progressbar" style="width: 25%; height: 4px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-violet"></div>
          </div>
        </div>
        <div class="number"><strong>{{$count['physician_count']}}</strong></div>
      </div>
    </div>
    <!-- Item -->
    <div class="col-xl-3 col-sm-6">
      <div class="item d-flex align-items-center">
        <div class="icon bg-red"><i class="fas fa-user-nurse"></i></div>
        <div class="title"><span>Nurses</span>
          <div class="progress">
            <div role="progressbar" style="width: 70%; height: 4px;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-red"></div>
          </div>
        </div>
        <div class="number"><strong>{{$count['nurse_count']}}</strong></div>
      </div>
    </div>
    <!-- Item -->
    <div class="col-xl-3 col-sm-6">
      <div class="item d-flex align-items-center">
        <div class="icon bg-green"><i class="fas fa-hospital-alt"></i></div>
        <div class="title"><span>Departments</span>
          <div class="progress">
            <div role="progressbar" style="width: 40%; height: 4px;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-green"></div>
          </div>
        </div>
        <div class="number"><strong>{{$count['department_count']}}</strong></div>
      </div>
    </div>
    <!-- Item -->
    <div class="col-xl-3 col-sm-6">
      <div class="item d-flex align-items-center">
        <div class="icon bg-orange"><i class="fas fa-person-booth"></i></div>
        <div class="title"><span>Patient Room</span>
          <div class="progress">
            <div role="progressbar" style="width: 50%; height: 4px;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-orange"></div>
          </div>
        </div>
        <div class="number"><strong>{{$count['room_count']}}</strong></div>
      </div>
    </div>
  </div>
</div>
...
<div class="container-fluid">
    ...
    <div class="row bg-white has-shadow">
      <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
        <div class="project-title d-flex align-items-center">
          <div class="image has-shadow"><img src="{{asset('admin_template/img/project-1.jpg')}}" alt="..." class="img-fluid"></div>
          <div class="text">
  ...
  <div class="project">
    <div class="row bg-white has-shadow">
      <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
        <div class="project-title d-flex align-items-center">
          <div class="image has-shadow"><img src="{{asset('admin_template/img/project-2.jpg')}}" alt="..." class="img-fluid"></div>
          <div class="text">
            <h3 class="h4">Project Title</h3><small>Lorem Ipsum Dolor</small>
          </div>
        </div>
  ...
  <div class="project">
    <div class="row bg-white has-shadow">
      <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
        <div class="project-title d-flex align-items-center">
          <div class="image has-shadow"><img src="{{asset('admin_template/img/project-3.jpg')}}" alt="..." class="img-fluid"></div>
          <div class="text">
            <h3 class="h4">Project Title</h3><small>Lorem Ipsum Dolor</small>
          </div>
        </div>
  ...
  <div class="project">
    <div class="row bg-white has-shadow">
      <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
        <div class="project-title d-flex align-items-center">
          <div class="image has-shadow"><img src="{{asset('admin_template/img/project-4.jpg')}}" alt="..." class="img-fluid"></div>
          <div class="text">
            <h3 class="h4">Project Title</h3><small>Lorem Ipsum Dolor</small>
          </div>
        </div>
    ...
    <div class="col-lg-4">
      <div class="client card">
        ...
        <div class="card-body text-center">
          <div class="client-avatar"><img src="{{asset('admin_template/img/avatar-2.jpg')}}" alt="..." class="img-fluid rounded-circle">
    ...
    <div class="col-lg-6">
      <div class="articles card">
        ...
        <div class="card-body no-padding">
          <div class="item d-flex align-items-center">
            <div class="image"><img src="{{asset('admin_template/img/avatar-1.jpg')}}" alt="..." class="img-fluid rounded-circle"></div>
            <div class="text"><a href="#">
                <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Aria Smith.   </small></div>
          </div>
          <div class="item d-flex align-items-center">
            <div class="image"><img src="{{asset('admin_template/img/avatar-2.jpg')}}" alt="..." class="img-fluid rounded-circle"></div>
            <div class="text"><a href="#">
                <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Frank Williams.   </small></div>
          </div>
          <div class="item d-flex align-items-center">
            <div class="image"><img src="{{asset('admin_template/img/avatar-3.jpg')}}" alt="..." class="img-fluid rounded-circle"></div>
            <div class="text"><a href="#">
                <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Ashley Wood.   </small></div>
          </div>
          <div class="item d-flex align-items-center">
            <div class="image"><img src="{{asset('admin_template/img/avatar-4.jpg')}}" alt="..." class="img-fluid rounded-circle"></div>
            <div class="text"><a href="#">
                <h3 class="h5">Lorem Ipsum Dolor</h3></a><small>Posted on 5th June 2017 by Jason Doe.   </small></div>
          </div>
          <div class="item d-flex align-items-center">
            <div class="image"><img src="{{asset('admin_template/img/avatar-5.jpg')}}" alt="..." class="img-fluid rounded-circle"></div>
            <div class="text"><a href="#">
        ...
        <div class="card-body no-padding">
          ...
          <div class="item">
            <div class="feed d-flex justify-content-between">
              <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="{{asset('admin_template/img/avatar-5.jpg')}}" alt="person" class="img-fluid rounded-circle"></a>
                <div class="content">
          ...
          <div class="item"> 
            <div class="feed d-flex justify-content-between">
              <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="{{asset('admin_template/img/avatar-2.jpg')}}" alt="person" class="img-fluid rounded-circle"></a>
                <div class="content">
          ...
          <div class="item clearfix">
            <div class="feed d-flex justify-content-between">
              <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="{{asset('admin_template/img/avatar-3.jpg')}}" alt="person" class="img-fluid rounded-circle"></a>
                <div class="content">
