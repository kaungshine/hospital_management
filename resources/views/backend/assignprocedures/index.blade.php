...
<div class="breadcrumb-holder container-fluid">
  <ul class="breadcrumb" style="position: relative;">
    ...
    <li class="breadcrumb-item active">Assign Procedure</li>
    @hasrole('admin')
    <a href="{{route('assignprocedures.create')}}" class="btn btn-info  text-right" style="position: absolute; right: 40px; bottom: 7px;">Add New</a>
    @endhasrole
  </ul>
</div>
<!-- Forms Section-->
      ...
      <div class="modal-body">
        ...
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <h3 class="h4">Physician_Procedure Edit Form</h3>
          </div>
          <div class="card-body">
            <form id="update-form" class="form-horizontal">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <select name="procedure" id="procedure" class="form-control mb-3">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input id="date" type="date" class="form-control form-control-warning" name="date">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    columns: [
    { 
          title: "Procedure",//Table Header/ Column Name
          class: "text-center",
          data: "procedure",
          searchable: true,
          orderable: true
    ...
    $('#location_table').on('click', '.btn_edit', function (e){
      ...
      .then(json => {
        $('#procedure').find("option:selected").attr('selected', false)
        $('#physician').find("option:selected").attr('selected', false)
        $('#procedure').find("option[value='" + json.procedure_id + "']").attr('selected', true)
