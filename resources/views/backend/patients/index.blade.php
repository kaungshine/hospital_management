...
<div class="breadcrumb-holder container-fluid">
  <ul class="breadcrumb" style="position: relative;">
    ...
    @hasrole('admin')
    <a href="{{route('patients.create')}}" class="btn btn-info  text-right" style="position: absolute; right: 40px; bottom: 7px;">Add New</a>
    @endhasrole
  </ul>
</div>
<!-- Forms Section-->
          ...
          <div class="card-body">
            <form id="update-form" class="form-horizontal">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input id="phone" name="phone" type="number" class="form-control form-control-warning">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-3 form-control-label">Insurance Number</label>
                <div class="col-sm-9">
                  <input id="insurance" name="insurance" type="number" class="form-control form-control-warning">
                </div>
              </div>
            </form>
          </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    data: @json($patients),//ho phet ka par lar tae variable
    columns: [
    { 
        ...
        },
        {
          ...
          render: function(data,type,row){           
           return '<h3><span class="badge badge-' + (data == 'cured' ? 'success' : 'danger' ) + '">' +  data  +  '</span></h3>'},
          searchable: true,
          orderable: true
        },
        ...
        @hasrole('physician')
        {
          ...
          data: null,
          render: function(data,type,row){
           return '<a type="button" href="{{route('prescribes.create')}}?id=' + data.id + '" class="btn btn-success btn_treatment"><i class="fas fa-heartbeat"></i></a>'},
           orderable: false,
           searchable: false
         },
         @endhasrole
    ...
    $('#location_table').on('click', '.btn_edit', function (e){
      ...
      .then(json => {
        ...
        $('#insurance').val(json.insuranceid)
